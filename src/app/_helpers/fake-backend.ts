  ...
  intercept(
    ...
    function register() {
        ...
        setTimeout(() => {
          alertService.info(
            `
                        ...
                        <p>If you don't know your password please visit the <a href="${
                          location.origin
      ...
      if (accounts.find(x => x.username === account.username)) {
        // display username already registered "username" in alert
        setTimeout(() => {
          alertService.info(
            `
                        <h4>Username Already Registered</h4>
                        <p>Your username ${
                          account.username
                        } is already registered.</p>
                        <p>If you don't know your password please visit the <a href="${
      ...
      setTimeout(() => {
        const verifyUrl = `${location.origin}/account/verify-email?token=${
        ...
        alertService.info(
          `
                    ...
                    <div><strong>NOTE:</strong> Extra marks to send real email.</div>
                `,
          { autoClose: false }
        );
      }, 1000);
    ...
    function forgotPassword() {
      ...
      setTimeout(() => {
        const resetUrl = `${location.origin}/account/reset-password?token=${
          account.resetToken
        }`;
        alertService.info(
          `
